-- Schema inicial do banco MCP local do Mestre do PC V10.
...
-- Tabela de sessões/auditoria do MCP local.
...
-- Tabela de memórias persistentes (opcional, além do JSON local).
...
-- Tabela de tarefas/agendamentos do MCP local.
